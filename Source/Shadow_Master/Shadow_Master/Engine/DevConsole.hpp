...
namespace shadow
{
	...
	public:
		...
		static void CreateInstance(EventSystem* eventsystem, const std::string& commandsFile )
		{
			s_pInstance = new DevConsole(eventsystem, commandsFile);
		}
